...
if __name__ == "__main__":
    ...
    # # model
    model = VGG16(weights=None, classes=2, input_shape=(192, 192, 3))
    # model = VGG19(weights=None, classes=2)
    ...
    model.compile(optimizer=tf.optimizers.SGD(0.005),  # 'sgd' 'adam' 'rmsprop'
