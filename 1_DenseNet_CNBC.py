...
from tensorflow.keras.applications.densenet import DenseNet121  # default input size 224x224
...
def DataSet():
    train_path_0 = 'Asian/'
    train_path_1 = 'Black/'
    train_path_2 = 'Caucasian/'
    train_path_3 = 'Hispanic/'
...
if __name__ == "__main__":
    ...
    # # model
    model = DenseNet121(weights=None, classes=4, input_shape=(192, 192, 3))
    ...
    # # save
    model.save('DenseNet121_CNBC.h5')
